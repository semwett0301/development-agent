...
class PlanStepOutput(BaseModel):
    ...
    action: str = Field(description="Action type: 'create', 'modify', or 'delete'")
...
class CodeGenerationOutput(BaseModel):
    ...
    edit_type: str = Field(description="Edit type: 'create', 'replace', 'insert', or 'delete'")
...
class TestErrorOutput(BaseModel):
    ...
    traceback: Optional[str] = Field(default=None, description="Relevant traceback")
